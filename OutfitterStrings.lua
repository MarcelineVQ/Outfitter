...
Outfitter_cWeaponSwapRetry = "Retry weapon swaps in combat";
Outfitter_cWeaponSwapRetryDescription = "When enabled, weapon swaps will be retried during combat if the initial swap fails due to GCD";
